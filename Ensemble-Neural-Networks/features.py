...
path_original = 'Ensemble-Neural-Networks/autoencoder_dataset/original/*.csv'
path_adapted = 'Ensemble-Neural-Networks/autoencoder_dataset/adapted/*.csv'
...
def adapt_features():
    ...
    if not os.path.exists('Ensemble-Neural-Networks/autoencoder_dataset/adapted'):
                os.makedirs('Ensemble-Neural-Networks/autoencoder_dataset/adapted')
    ...
    for f in files:
        ...
        df = df[features]
        df.to_csv('Ensemble-Neural-Networks/autoencoder_dataset/adapted/{}.csv'.format(crypto), index=False)
